...
Section Utilities.
  ...
  Lemma compute_tr_eq_is_tree {actions i gm dir} :
    forall {tr}, tr = compute_tr actions i gm dir -> is_tree rer actions i gm dir tr.
  Proof.
    intros. subst. apply compute_tr_is_tree.
  Qed.
