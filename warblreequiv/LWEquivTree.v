...
(* `tm_valid tm rer lreg` means that the TMatcher tm recognizes the regexp lreg on any input, and yields a valid backtree. *)
...
Section Main.
  ...
  Theorem tmatcher_bt: forall wreg lreg ctx,
